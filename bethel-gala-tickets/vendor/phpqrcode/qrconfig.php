 ...
 *
 * Local modification: every define is guarded so the host application can set
 * these first. The plugin disables QR_CACHEABLE and QR_LOG_DIR before loading
 * the library, because the bundled cache/ directory does not exist and writing
 * inside a plugin folder is not reliable across hosts.
 */
